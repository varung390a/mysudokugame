...
public class Game extends Observable {
    ...
    {
                  final String username = "varung390a@gmail.com"; // enter your mail id
	  	final String password = "ritimagupta1992#";// enter ur password
		...
		try {
			...
			message.setFrom(new InternetAddress("varung390a@gmail.com")); // same email id
			message.setRecipients(Message.RecipientType.TO,
				InternetAddress.parse("varung391a@gmail.com"));// whome u have to send mails that person id
			message.setSubject("SUDUKO GAME RESULT");
                      int count=5;
			message.setText("HELLO DEAR,"
				+ "\n\n your have played very well and your score is"+" "+count);

			Transport.send(message);
		JOptionPane.showMessageDialog(null,"Dear player your score  has been  successfully send to your email id"); 
